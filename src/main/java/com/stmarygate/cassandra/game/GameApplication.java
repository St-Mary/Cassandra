...
public class GameApplication extends Application {
  ...
  public void start(Stage primaryStage) throws Exception {
    ...
    Font.loadFont(getClass().getClassLoader().getResource("fonts/retrogaming.ttf").toExternalForm(),
            30);
    ...
    primaryStage.getIcons().add(new Image(getClass().getClassLoader().getResource("img/icon.png").toString()));
